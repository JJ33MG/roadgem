      ...
      >
        ...
        <div className="glass-panel">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-16">
            <div>
              <label htmlFor="name" className="mb-8 block text-body-sm text-silver">Full name</label>
              <input
                id="name"
                type="text"
                placeholder="Jarne"
            ...
            <div>
              ...
              <input
                ...
                minLength={8}
              />
              <p className="mt-4 text-caption text-lead">At least 8 characters</p>
            </div>
        ...
        <p className="mt-24 text-center text-body-sm text-silver">
          ...
          <Link to="/login" className="font-w480 text-mercury-blue hover:underline">
            Sign in
          </Link>
        </p>
      </motion.div>
